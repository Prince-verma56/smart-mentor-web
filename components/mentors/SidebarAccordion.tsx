...
export function SidebarAccordion({
  ...
  return (
    <div className="flex flex-col mb-2 w-full mt-2">
      ...
      <button
        onClick={toggle}
        className="flex items-center w-full px-3 py-0.5 text-[10px] font-bold tracking-widest uppercase text-muted-foreground/50 hover:text-foreground transition-colors group"
      >
        <ChevronRight
          className={cn(
            "h-3 w-3 mr-1.5 transition-transform duration-200 opacity-50 group-hover:opacity-100",
